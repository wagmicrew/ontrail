# Configure Nginx & PM2 for Ontrail Production Setup
...
Write-Host "• Check status: ssh root@$ServerHost 'ontrail-status.sh'" -ForegroundColor White
Write-Host "• View logs: ssh root@$ServerHost 'pm2 logs'" -ForegroundColor White
Write-Host "• Restart app: ssh root@$ServerHost 'pm2 restart ontrail-app'" -ForegroundColor White
